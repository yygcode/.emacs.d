...
Call 'c-show-syntactic-information' to show the syntactic before the cursor.
...
#+begin_src emacs-lisp
  ...
  (defconst y/java-style-basic
    '((c-tab-always-indent . nil) ; manualy added
      ...
      (c-offsets-alist
       ...
       (topmost-intro-cont . c-lineup-topmost-intro-cont)))
    "y/java-basic")
  (c-add-style "y/java-basic" y/java-style-basic)

  (defconst y/java-style-alibaba
    '((c-tab-always-indent . nil) ; manualy added
      (c-basic-offset . 4)     ; Guessed value
      (c-offsets-alist
       (block-close . 0)       ; Guessed value
       ...
       (topmost-intro-cont . c-lineup-topmost-intro-cont)))
    "y/java-alibaba")
  (c-add-style "y/java-alibaba" y/java-style-alibaba)
  ...
  (defun y/java-style-hook()
    "Config java style depends on file pathname"
    (when (buffer-file-name)
      (cond ((or (string-match "/hdfs/" (buffer-file-name))
                 (string-match "/dfs/" (buffer-file-name)))
             (c-set-style "y/java-alibaba"))
            (t ;; all default to y/c-basic
             (c-set-style "y/java-basic")))))
  (add-hook 'c-mode-common-hook 'y/c-style-hook)
  (add-hook 'java-mode-hook 'y/java-style-hook)
#+end_src
